...
<div align="center">
<h2> Wodo Platform Blockchain API Definitions </h2>
</div>
...
- [Adding wp-blockchain-api dependency](#adding-wp-blockchain-api-dependency)
...
Please follow the steps below to publish wp-blockchain-api npm package from your local development environment.
...
Verif that wp-blockchain-api package has been published successfully with the correct version you provided in package.json file. Go to the page below and make sure that your packge is listed on the  published artifact list
...
```
"dependencies": {
        "@wodo-platform/wp-blockchain-api": "1.0.0",
...
##  Adding wp-blockchain-api dependency

To be able to add wp-blockchain-api as npm dependency, you need to authenticate to git remote npm package repository by logging in to npm, use the npm login command, replacing USERNAME with your GitHub username, TOKEN with your personal access token, and PUBLIC-EMAIL-ADDRESS with your email address.
